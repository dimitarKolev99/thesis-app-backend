...
//                .encodeToString(cipherText);
    ...
    public static SecretKey getKeyFromPassword(String applianceSerial, byte[] salt)
            throws NoSuchAlgorithmException, InvalidKeySpecException {
        SecretKeyFactory factory = SecretKeyFactory.getInstance("PBKDF2WithHmacSHA256");
        KeySpec spec = new PBEKeySpec(applianceSerial.toCharArray(), salt, 65536, 256);
        SecretKey secret = new SecretKeySpec(factory.generateSecret(spec)
                .getEncoded(), "AES");
        return secret;
    }

    public static byte[] generateIv() throws IOException, NoSuchAlgorithmException {
...
//        LOGGER.debug("IV BYTE ARRAY: ", Arrays.toString(iv));
//        FileOutputStream fs = new FileOutputStream(new File("paramFile"));
//        BufferedOutputStream bos = new BufferedOutputStream(fs);
//        bos.write(iv);
//        bos.close();

        return new byte[] { 95, 109, 23, -89, -124, -46, -16, 121, 87, -58, 111, -22, 21, 121, -63, 109 };
